...
(
    ...
    CONSTRAINT FK_LOCAL_AUTH FOREIGN KEY (USER_ID) REFERENCES USER (ID)
);
...
(
    ...
    CREATE_TIME        TIMESTAMP   NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '信息创建时间',
    UPDATE_TIME        TIMESTAMP   NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '信息更新时间',
    CONSTRAINT FK_O_AUTH FOREIGN KEY (USER_ID) REFERENCES USER (ID),
    CONSTRAINT USER_ID UNIQUE (USER_ID)
);
...
(
    ...
    CONSTRAINT FK_USERID_3 FOREIGN KEY (USER_ID) REFERENCES USER (ID),
    CONSTRAINT FK_USERID_4 FOREIGN KEY (FOLLOWED_USER_ID) REFERENCES USER (ID),
...
(
    ...
    CREATE_TIME TIMESTAMP   NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    UPDATE_TIME TIMESTAMP   NULL     DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    CONSTRAINT NOTIFY_IBFK_1 FOREIGN KEY (SENDER_ID) REFERENCES USER (ID),
...
(
    ...
    CREATE_TIME TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    UPDATE_TIME TIMESTAMP NULL     DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    CONSTRAINT FK_USER_ROLE_MAP FOREIGN KEY (USER_ID) REFERENCES USER (ID),
