...
(
    ...
    STATUS      INT                   DEFAULT 1 NOT NULL COMMENT '1: 个人专题标签, 0: 公开文章标签',
    AVATAR_HASH MEDIUMTEXT NULL COMMENT '专题介绍图片HASH',
    CREATE_TIME TIMESTAMP    NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    UPDATE_TIME TIMESTAMP    NULL     DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
(
    ...
    UPDATE_TIME   TIMESTAMP NULL     DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    CREATE_TIME   TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    STATUS        INT                DEFAULT 1 COMMENT '文章状态:0：封禁，1: 草稿, 2: 公开, 3: 自己可见, 4: 粉丝可见',
